...
class NoteRepositoryImpl implements NoteRepository{
  ...
  @override
  Future<Note> createNote({required CreateNoteDto note, required File file, void Function(int sent, int total)? onSendProgress }) async{
    final uploadedNote = await _noteRemoteDataSource.createNote(note: note, file: file, onSendProgress: onSendProgress);
