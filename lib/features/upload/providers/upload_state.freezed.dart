...
mixin _$UploadState {
 ...
 UploadFile? get uploadFile; List<XFile> get selectedImages; String get title; String get description; String? get subject; String? get branch; NoteCategory? get noteCategory; List<String> get tags; String? get course; String? get collegeName; String? get university; int? get semester; int? get previewIndex; bool get isPublic; bool get isGeneratingPDF; bool get isPickingDocument; bool get isUploading; String? get error;
...
@override
int get hashCode => Object.hash(runtimeType,uploadFile,const DeepCollectionEquality().hash(selectedImages),title,description,subject,branch,noteCategory,const DeepCollectionEquality().hash(tags),course,collegeName,university,semester,previewIndex,isPublic,isGeneratingPDF,isPickingDocument,isUploading,error);

@override
String toString() {
  return 'UploadState(uploadFile: $uploadFile, selectedImages: $selectedImages, title: $title, description: $description, subject: $subject, branch: $branch, noteCategory: $noteCategory, tags: $tags, course: $course, collegeName: $collegeName, university: $university, semester: $semester, previewIndex: $previewIndex, isPublic: $isPublic, isGeneratingPDF: $isGeneratingPDF, isPickingDocument: $isPickingDocument, isUploading: $isUploading, error: $error)';
}
...
@useResult
$Res call({
 UploadFile? uploadFile, List<XFile> selectedImages, String title, String description, String? subject, String? branch, NoteCategory? noteCategory, List<String> tags, String? course, String? collegeName, String? university, int? semester, int? previewIndex, bool isPublic, bool isGeneratingPDF, bool isPickingDocument, bool isUploading, String? error
});
...
/// Create a copy of UploadState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uploadFile = freezed,Object? selectedImages = null,Object? title = null,Object? description = null,Object? subject = freezed,Object? branch = freezed,Object? noteCategory = freezed,Object? tags = null,Object? course = freezed,Object? collegeName = freezed,Object? university = freezed,Object? semester = freezed,Object? previewIndex = freezed,Object? isPublic = null,Object? isGeneratingPDF = null,Object? isPickingDocument = null,Object? isUploading = null,Object? error = freezed,}) {
...
as String?,noteCategory: freezed == noteCategory ? _self.noteCategory : noteCategory // ignore: cast_nullable_to_non_nullable
as NoteCategory?,tags: null == tags ? _self.tags : tags // ignore: cast_nullable_to_non_nullable
as List<String>,course: freezed == course ? _self.course : course // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UploadFile? uploadFile,  List<XFile> selectedImages,  String title,  String description,  String? subject,  String? branch,  NoteCategory? noteCategory,  List<String> tags,  String? course,  String? collegeName,  String? university,  int? semester,  int? previewIndex,  bool isPublic,  bool isGeneratingPDF,  bool isPickingDocument,  bool isUploading,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UploadState() when $default != null:
return $default(_that.uploadFile,_that.selectedImages,_that.title,_that.description,_that.subject,_that.branch,_that.noteCategory,_that.tags,_that.course,_that.collegeName,_that.university,_that.semester,_that.previewIndex,_that.isPublic,_that.isGeneratingPDF,_that.isPickingDocument,_that.isUploading,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UploadFile? uploadFile,  List<XFile> selectedImages,  String title,  String description,  String? subject,  String? branch,  NoteCategory? noteCategory,  List<String> tags,  String? course,  String? collegeName,  String? university,  int? semester,  int? previewIndex,  bool isPublic,  bool isGeneratingPDF,  bool isPickingDocument,  bool isUploading,  String? error)  $default,) {final _that = this;
switch (_that) {
case _UploadState():
return $default(_that.uploadFile,_that.selectedImages,_that.title,_that.description,_that.subject,_that.branch,_that.noteCategory,_that.tags,_that.course,_that.collegeName,_that.university,_that.semester,_that.previewIndex,_that.isPublic,_that.isGeneratingPDF,_that.isPickingDocument,_that.isUploading,_that.error);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UploadFile? uploadFile,  List<XFile> selectedImages,  String title,  String description,  String? subject,  String? branch,  NoteCategory? noteCategory,  List<String> tags,  String? course,  String? collegeName,  String? university,  int? semester,  int? previewIndex,  bool isPublic,  bool isGeneratingPDF,  bool isPickingDocument,  bool isUploading,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _UploadState() when $default != null:
return $default(_that.uploadFile,_that.selectedImages,_that.title,_that.description,_that.subject,_that.branch,_that.noteCategory,_that.tags,_that.course,_that.collegeName,_that.university,_that.semester,_that.previewIndex,_that.isPublic,_that.isGeneratingPDF,_that.isPickingDocument,_that.isUploading,_that.error);case _:
  return null;
...
class _UploadState implements UploadState {
  const _UploadState({this.uploadFile, final  List<XFile> selectedImages = const <XFile>[], this.title = "", this.description = "", this.subject, this.branch, this.noteCategory, final  List<String> tags = const <String>[], this.course, this.collegeName, this.university, this.semester, this.previewIndex, this.isPublic = true, this.isGeneratingPDF = false, this.isPickingDocument = false, this.isUploading = false, this.error}): _selectedImages = selectedImages,_tags = tags;
...
@override
int get hashCode => Object.hash(runtimeType,uploadFile,const DeepCollectionEquality().hash(_selectedImages),title,description,subject,branch,noteCategory,const DeepCollectionEquality().hash(_tags),course,collegeName,university,semester,previewIndex,isPublic,isGeneratingPDF,isPickingDocument,isUploading,error);
