...
class UploadFilePlaceholder extends StatelessWidget{
  ...
  const UploadFilePlaceholder({required this.onTap, required this.isGeneratingPDF, required this.isPickingImages, super.key});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              :
              MultiUtilityButton(onPressed: onTap, text: "Select File",)
            ],
          ),
        ),
      )
